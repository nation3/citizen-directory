import { CurrencyDollarIcon, HomeIcon, LockClosedIcon, NewspaperIcon, PlusIcon, Squares2X2Icon, UserPlusIcon, UsersIcon } from "@heroicons/react/24/outline";
import { Nation3App, DefaultLayout, DefaultSidebar } from "@nation3/components";
import { useAccount, useConnect, useDisconnect } from "wagmi";
import { appDomain, balancerDomain, etherscanDomain, nationToken } from '../lib/config'
